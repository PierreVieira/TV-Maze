...
import org.pierre.tvmaze.feature.search.presentation.factory.impl.NewSearchStateFromHistoryFactoryImpl
...
val searchPresentationModule = module {
    ...
    factoryOf(::NewSearchStateFromHistoryFactoryImpl).bind<NewSearchStateFromHistoryFactory>()
}
